import { HoundConfigRepo } from "./types";

export function EscapeRegExp(regexp: string) {
    return regexp.replace(/[-[\]{}()*+!<=:?.\/\\^$|#\s,]/g, '\\$&');
}

export function ExpandVars(template: string, values: any) {
...
export function UrlParts(repo: HoundConfigRepo, pathArg?: string, line?: number, rev?: string) {
...
export function UrlToRepo(repo: HoundConfigRepo, path: string, line: number, rev: string) {
